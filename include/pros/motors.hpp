...
class Motor {
 public:
   ...
   */
  [[deprecated(
      "Changing these values is not supported by VEX and may lead to permanent "
      "motor damage.")]] static motor_pid_s_t
  ...
  [[deprecated(
      "Changing these values is not supported by VEX and may lead to permanent "
      "motor damage.")]] virtual std::int32_t
...
class Motor_Group {
 public:
   ...
   * \endcode
   */
  std::vector<std::int32_t> get_raw_positions(
      std::vector<std::uint32_t*>& timestamps);
  /****************************************************************************/
  /**                      Motor configuration functions                     **/
  /**                                                                        **/
